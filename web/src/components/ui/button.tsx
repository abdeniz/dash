...
const buttonVariants = cva(
  "focus-visible:border-ring focus-visible:ring-ring/30 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-md border border-transparent bg-clip-padding text-xs/relaxed font-medium focus-visible:ring-[2px] aria-invalid:ring-[2px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none",
  {
    variants: {
      variant: {
        default:
          "bg-linear-to-b from-primary to-primary/80 text-primary-foreground hover:from-primary/95 hover:to-primary/90 transition-colors border-primary/60 active:bg-red-400",
        outline:
          "text-foreground bg-linear-to-b from-popover-foreground/10 to-popover/5 border-border/60 dark:hover:bg-popover/60 dark:hover:to-popover/50 active:bg-muted/20",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
          "hover:bg-muted hover:text-foreground dark:hover:bg-muted/50 aria-expanded:bg-muted aria-expanded:text-foreground",
        destructive:
          "bg-linear-to-b from-destructive/10 to-destructive/5 border border-destructive/15 dark:from-destructive/20 dark:to-destructive/10 text-destructive focus-visible:border-destructive/40 dark:hover:bg-destructive/20",
